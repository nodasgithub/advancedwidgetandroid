package com.example.advancedwidgetandroid;
...
public class NewsService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (ApplicationClass.connectionAvailable(getApplicationContext())) {
            RemoteViews views = new RemoteViews("com.example.advancedwidgetandroid", R.layout.new_app_widget);
            ...
            Toast.makeText(getApplicationContext(), "Please make sure your phone has na active internet connection!", Toast.LENGTH_SHORT).show();
            stopSelf();
        }
